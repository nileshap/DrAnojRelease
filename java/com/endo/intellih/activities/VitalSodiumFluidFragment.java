...
public class VitalSodiumFluidFragment extends Fragment {

    public static final String TAG = VitalSodiumFluidFragment.class.getSimpleName();
    ...
    public static Fragment newInstance(Context context) {
        VitalSodiumFluidFragment f = new VitalSodiumFluidFragment();
