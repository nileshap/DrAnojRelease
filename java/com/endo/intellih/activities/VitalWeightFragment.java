...
public class VitalWeightFragment extends Fragment {

    public static final String TAG = VitalWeightFragment.class.getSimpleName();
    ...
    public static Fragment newInstance(Context context) {
        VitalWeightFragment f = new VitalWeightFragment();
